...
class customAOS_QuotesViewEdit extends AOS_QuotesViewEdit
{
    ...
    {
        // require("http://crm.tbcrm.com/index.php?module=AOS_Quotes&action=suite_new&record=b9883fe5-4910-b984-e2ff-64918b1bed8b");
        // die;
        header("Location: index.php?module=AOS_Quotes&action=jd_customQuote&record=".$this->bean->id);
        die;
        // global $db;
        // /*
